...
// HelpPage (كما هو موجود في help.dart مع تعديل بسيط للتنقل)
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pop(context); // عودة للشاشة السابقة بدل pushReplacement
          },
        ),
        title: const Text(
          'المساعدة',
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: const Color(0xFF030B4E).withOpacity(0.1),
