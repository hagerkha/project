...
class _ShoeIntroScreenState extends State<ShoeIntroScreen> {
  ...
  final List<String> imagePaths = [
    'assets/videos/shose/1.jpg',
    'assets/videos/shose/2.jpg',
    'assets/videos/shose/3.jpg',
    'assets/videos/shose/4.jpg',
    'assets/videos/shose/5.jpg',
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('لبس الحذاء'),
        backgroundColor: const Color(0xFFd39593),
      ),
      body: Column(
        children: [
