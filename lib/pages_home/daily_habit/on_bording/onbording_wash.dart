...
class _WashHandsIntroScreenState extends State<WashHandsIntroScreen> {
  ...
  final List<String> imagePaths = [
    'assets/videos/wash_hands/1.jpg',
    'assets/videos/wash_hands/2.jpg',
    'assets/videos/wash_hands/3.jpg',
    'assets/videos/wash_hands/4.jpg',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('غسل اليدين'),
        backgroundColor: const Color(0xFFe1edf9),
      ),
      body: Column(
        children: [
