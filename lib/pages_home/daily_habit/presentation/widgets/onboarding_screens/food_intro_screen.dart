...
class FoodIntroScreen extends StatefulWidget {
  ...
  const FoodIntroScreen({Key? key, required this.onContinue}) : super(key: key);
...
class _FoodIntroScreenState extends State<FoodIntroScreen> {
  ...
  final List<String> imagePaths = [
    'assets/videos/food/1.jpg', 'assets/videos/food/2.jpg', 'assets/videos/food/3.jpg',
    'assets/videos/food/4.jpg', 'assets/videos/food/5.jpg', 'assets/videos/food/6.jpg',
    'assets/videos/food/7.jpg', 'assets/videos/food/8.jpg',
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('آداب الطعام'), backgroundColor: const Color(0xFF97d5fa)),
      body: Column(
        children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: List.generate(imagePaths.length, (index) => AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: _currentPage == index ? const Color(0xFF97d5fa) : Colors.grey[300],
            ...
            child: SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xFF97d5fa),
