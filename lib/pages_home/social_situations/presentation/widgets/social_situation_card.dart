...
class SocialSituationCard extends StatelessWidget {
  final IconData icon;
  final String title;
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(description, style: const TextStyle(fontSize: 18, color: Colors.black, fontWeight: FontWeight.bold, height: 1.4), maxLines: 3, overflow: TextOverflow.ellipsis),
                ],
              ),
            ),
